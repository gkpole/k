...
bot = telebot.TeleBot('5616794289:AAE-dFO8qZRwydbbZMWOiXHv1NWFkrFRLpU') # Токен бота воркеров

admin = 5893628848 # ID Админа
support = 5893628848 # ID сапорта
channel_id = 5893628848 # ID Канала залётов
chat_worker_id = 5893628848 # ID Чата с воркерами

bot_name = 'Cndksppwodkdbot' # Username Бота

mater = '-' # Ссылка на мануалы
zalet = '-' # Ссылка на канал с залётами
infos = '-' # Ссылка на инфо канал
pname = 'Название Тимы' # Название проекта
pdate = '31.01.23' # Дата созданя проекта
